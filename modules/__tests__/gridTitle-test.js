...
describe("GridTitle", function () {
	...
	beforeEach(function () {
		...
		title = TestUtils.renderIntoDocument(React.createElement(GridTitle, { columns: columns, columnSettings: columnSettings, sortSettings: sortObject }));
	});
	...
	it("doesnt sort column where sort is disabled", function () {
		...
		var title2 = TestUtils.renderIntoDocument(React.createElement(GridTitle, { columns: columns, columnSettings: columnSettings2, sortSettings: sortObject }));
