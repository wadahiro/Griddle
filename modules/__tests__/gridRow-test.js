...
describe("GridRow", function () {
		it("does not call toggleChildren if no child rows are specified", function () {
				var columnSettings = new ColumnProperties(_.keys(fakeData[0]), [], "children", [], []);

				row = TestUtils.renderIntoDocument(React.createElement(GridRow, { data: fakeData[0], columnSettings: columnSettings }));
		...
		it("calls toggleChildren if child rows are specified", function () {
				var columnSettings = new ColumnProperties(_.keys(fakeSubgridData[0]), [], "children", [], []);

				row2 = TestUtils.renderIntoDocument(React.createElement(GridRow, { data: fakeSubgridData[0], hasChildren: true, columnSettings: columnSettings }));
