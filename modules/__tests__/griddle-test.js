...
var SomeCustomComponent = React.createClass({
  displayName: "SomeCustomComponent",
  render: function () {
...
describe("Griddle", function () {
  ...
  var CustomGridComponent = React.createClass({
    displayName: "CustomGridComponent",
  ...
  beforeEach(function () {
    ...
    grid = TestUtils.renderIntoDocument(React.createElement(Griddle, { results: fakeData, gridClassName: "test" }));
  });
  ...
  it("uses results when external not set", function () {
    grid2 = TestUtils.renderIntoDocument(React.createElement(Griddle, { results: fakeData, gridClassName: "test" }));
  ...
  it("calls external sort function when clicked and useExternal is true", function () {
    ...
    var grid2 = TestUtils.renderIntoDocument(React.createElement(Griddle, { externalResults: fakeData,
      results: fakeData2,
      useExternal: true,
  ...
  it("uses custom row component when set", function () {
    var grid2 = TestUtils.renderIntoDocument(React.createElement(Griddle, { results: fakeData, useCustomRowComponent: true, customRowComponent: SomeCustomComponent }));
  ...
  it("should throw an error if useCustomRowComponent is true and no component is added", function () {
    var grid2 = TestUtils.renderIntoDocument(React.createElement(Griddle, { results: fakeData, useCustomRowComponent: true }));
  ...
  it("uses custom grid component when set", function () {
    var grid2 = TestUtils.renderIntoDocument(React.createElement(Griddle, { results: fakeData, useCustomGridComponent: true, customGridComponent: SomeCustomComponent }));
  ...
  it("should throw an error if useCustomGridComponent is true and no component is added", function () {
    var grid2 = TestUtils.renderIntoDocument(React.createElement(Griddle, { results: fakeData, useCustomGridComponent: true }));
  ...
  it("should not show footer when useCustomGridComponent is true", function () {
    var grid2 = TestUtils.renderIntoDocument(React.createElement(Griddle, { results: fakeData, gridClassName: "test", useCustomGridComponent: true, customGridComponent: CustomGridComponent }));
  ...
  it("should show footer when useCustomGridComponent is false", function () {
    var grid2 = TestUtils.renderIntoDocument(React.createElement(Griddle, { results: fakeData, gridClassName: "test" }));
  ...
  it("should give the grid the entire dataset and not use the filtered data", function () {
    var griddle2 = React.createElement(Griddle, { results: fakeData, gridClassName: "test", resultsPerPage: 1, useCustomGridComponent: true, customGridComponent: CustomGridComponent });
